...
// denifición de emociones (6 emociones)
const emocionesBase = [
...
btnGirar.addEventListener("click", () => {
    ...
    setTimeout(() => {
        ...
        //color de emoción
        const colorEmocion = getComputedStyle(document.body).getPropertyValue(padre.color).trim();
